...
def get_model(args):
    ...
    if args.lr_schedule == 'cosine':
        ...
        lrs = create_cosine_lr_schedule_with_window(args.warmup_epochs * args.num_steps_per_epoch, args.warmup_epochs * args.num_steps_per_epoch, args.epochs * args.num_steps_per_epoch)
