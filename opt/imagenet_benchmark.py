...
lr_scaler = hvd.size() * args.batches_per_allreduce if not args.use_adasum else 1
...
for x in range(args.num_iters):
    ...
    img_sec = args.batch_size * args.batches_per_allreduce * args.num_batches_per_iter / time
